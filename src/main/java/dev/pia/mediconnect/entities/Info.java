...
public class Info {
    ...
    // STOPPED HERE ON OCTOBER21, 2022
    /* relationship to patient - a record can only belong to one patient and vice versa */
    ...
    public Info(InfoDto infoDto) {
        ...
        if (infoDto.getFirstName() != null) {
            this.firstName = infoDto.getFirstName();
        }
        if (infoDto.getLastName() != null) {
            this.lastName = infoDto.getLastName();
        }
        if (infoDto.getDateOfBirth() != null) {
            this.dateOfBirth = infoDto.getDateOfBirth();
        }
        ...
        if (infoDto.getCity() != null) {
            this.city = infoDto.getCity();
        }
        if (infoDto.getState() != null) {
            this.state = infoDto.getState();
        }
        if (infoDto.getZip() != null) {
            this.zip = infoDto.getZip();
        }
        if (infoDto.getInsurance() != null) {
            this.insurance = infoDto.getInsurance();
        }
        if (infoDto.getAllergies() != null) {
            this.allergies = infoDto.getAllergies();
        }
        if (infoDto.getConditions() != null) {
            this.conditions = infoDto.getConditions();
        }
        if (infoDto.getMedications() != null) {
            this.medications = infoDto.getMedications();
        }
    }
    ...
    public String toString() {
        return "Info [id=" + id + ", firstName=" + firstName
